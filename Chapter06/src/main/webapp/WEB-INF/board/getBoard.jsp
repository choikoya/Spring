...
<table border="1" cellpadding="0" cellspacing="0">
	<tr>
		<td bdcolor="orange" width="70">제목</td><td align="left">
		<input type="text" name="title" value="${board.title }"/></td>
	</tr>
	<tr>
		<td bdcolor="orange">작성자</td><td align="left">
		${board.writer }</td>
	</tr>
	<tr>
		<td bdcolor="orange">등록일</td><td align="left">
		<fmt:formatDate value="${board.createDate }"
	pattern = "yyyy-MM-dd"></fmt:formatDate></td>
	</tr>
	<tr>
		<td bdcolor="orange">조회수</td><td align="left">
		${board.cnt }</td>
	</tr>
	<tr>
